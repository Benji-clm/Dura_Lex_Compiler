...
SOURCES := $(wildcard src/*.cpp) $(wildcard src/operation/*.cpp) $(wildcard src/function/*.cpp) $(wildcard src/conditional/*.cpp) $(wildcard src/array/*.cpp) $(wildcard src/misc/*.cpp) $(wildcard src/pointer/*.cpp) $(wildcard src/primitives/*.cpp) $(wildcard src/struct/*.cpp)  # all .cpp files are to be considered source files
